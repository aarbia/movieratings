...
INSERT INTO `cast` (`movie_id`, `actor_name`, `character_name`) VALUES
(417657983, 'Tim Robbins', 'Andy Dufresne');
(417657983, 'Morgan Freeman', 'Ellis Boyd \'Red\' Redding');
(417657983, 'Bob Gunton', 'Warden Norton');
(417657983, 'Willam Sadler', 'Heywood');
(417657983, 'Clancy Brown', 'Captain Hadley');
(896862764, 'Marlon Brando', 'Don Vito Corleone');
(896862764, 'Al Pacino', 'Michael');
(896862764, 'James Caan', 'Sonny');
(896862764, 'Richard S. Castellano', 'Clemenza');
(896862764, 'Robert Duvall', 'Tom Hagen');
(1127715346, 'Christian Bale', 'Bruce Wayne / Batman');
(1127715346, 'Heath Ledger', 'Joker');
(1127715346, 'Aaron Eckhart', 'Harvey Dent');
(1127715346, 'Michael Caine', 'Alfred');
(1127715346, 'Gary Oldman', 'Commissioner Gordon');
(1257495259, 'Al Pacino', 'Michael');
(1257495259, 'Robert Duvall', 'Tom Hagen');
(1257495259, 'Diane Keaton', 'Kay');
(1257495259, 'Robert De Niro', 'Vito Corleone');
(1257495259, 'John Cazale', 'Fredo Corleone');
(1301349790, 'Liam Neeson', 'Oskar Schindler');
(1301349790, 'Ben Kingsley', 'Itzhak Stern');
(1301349790, 'Ralph Fiennes', 'Amon Goeth');
(1301349790, 'Caroline Goodall', 'Emilie Schindler');
(1301349790, 'Jonathan Sagall', 'Poldek Pfefferberg');
(1793535987, 'Elijah Wood', 'Frodo');
(1793535987, 'Ian McKellen', 'Gandalf');
(1793535987, 'Viggo Mortensen', 'Aragorn');
(1793535987, 'Liv Tyler', 'Arwen');
(1793535987, 'Sean Astin', 'Sam');
(806225442, 'Henry Fonda', 'Juror 8 \'Davis\'');
(806225442, 'Lee J. Cobb', 'Juror 3');
(806225442, 'Martin Balsam', 'Juror 1');
(806225442, 'Ed Begley', 'Juror 10');
(806225442, 'E. G. Marshall', 'Juror 4');
(1645878938, 'Ian McKellan', 'Gandalf');
(1645878938, 'Elijah Wood', 'Frodo');
(1645878938, 'Viggo Mortensen', 'Aragorn');
(1645878938, 'Orlando Bloom', 'Legolas');
(1645878938, 'Cate Blanchett', 'Galadriel');
(283477760, 'John Travolta', 'Vincent Vega');
(283477760, 'Samuel L. Jackson', 'Jules Winnfield');
(283477760, 'Uma Thurman', 'Mia Wallace');
(283477760, 'Ving Rhames', 'Marsellus Wallace');
(283477760, 'Harvey Keitel', 'The Wolf');
(1391240742, 'Leonardo DiCaprio', 'Dom Cobb');
(1391240742, 'Ken Watanabe', 'Saito');
(1391240742, 'Joseph Gordon-Levitt', 'Arthur');
(1391240742, 'Marion Cotillard', 'Mal');
(1391240742, 'Elliot Page', 'Ariadne');
(1278412978, 'Edward Norton', 'Narrator');
(1278412978, 'Brad Pitt', 'Tyler Durden');
(1278412978, 'Helena Bonham Carter', 'Marla Singer');
(1278412978, 'Meat Loaf', 'Robert \'Bob\' Paulson');
(1278412978, 'Jared Leto', 'Angel Face');
(1371031223, 'Tom Hanks', 'Forrest Gump');
(1371031223, 'Mykelti Williamson', 'Benjamin Buford \'Bubba\' Blue');
(1371031223, 'Robin Wright', 'Jenny Curran');
(1371031223, 'Sally Field', 'Mrs. Gump');
(1371031223, 'Gary Sinise', 'Lieutenant Dan');
(530844038, 'Elijah Wood', 'Frodo');
(530844038, 'Ian McKellen', 'Gandalf');
(530844038, 'Viggo Mortensen', 'Aragorn');
(530844038, 'Sean Astin', 'Samwise Gamgee');
(530844038, 'Andy Serkis', 'Gollum');
(2057653367, 'Clint Eastwood', 'Blondie / \'The Good\'');
(2057653367, 'Lee Van Cleef', 'Sentenza / Angel Eyes / \'The Bad\'');
(2057653367, 'Eli Wallach', 'Tuco \'The Ugly\'');
(2057653367, 'Aldo Giuffre', 'Union Captain');
(2057653367, 'Luigi Pistilli', 'Father Pablo Ramirez');
(1848618840, 'Vikrant Massey', 'Manoj Sharma');
(1848618840, 'Medha Shankr', 'Shraddha Joshi');
(1848618840, 'Anant Joshi', 'Pritam Pandey');
(1848618840, 'Anshuman Pushkar', 'Gaurinandan');
(1848618840, 'Geeta Agrawal Sharma', 'Pushpa Sharma');
(1322007046, 'Matthew McConaughey', 'Joseph Cooper');
(1322007046, 'Michael Caine', 'Professor John Brand');
(1322007046, 'Ellen Burstyn', 'Old Murph');
(1322007046, 'Anne Hathaway', 'Dr. Amelia Brand');
(1322007046, 'Casey Affleck', 'Adult Tom');
(855889485, 'Robert De Niro', 'James Conway');
(855889485, 'Ray Liotta', 'Henry Hill');
(855889485, 'Joe Pesci', 'Tommy DeVito');
(855889485, 'Lorraine Bracco', 'Karen Hill');
(855889485, 'Paul Sorvino', 'The Director');
(1440730664, 'Keanu Reeves', 'Neo');
(1440730664, 'Laurence Fishburne', 'Morpheus');
(1440730664, 'Carrie-Anne Moss', 'Trinity');
(1440730664, 'Hugo Weaving', 'Agent Smith');
(1440730664, 'Gloria Foster', 'Oracle');
(1018157845, 'Jack Nicholson', 'Randle Patrick \'R.P\' McMurphy');
(1018157845, 'Danny DeVito', 'Martini');
(1018157845, 'Christopher Lloyd', 'Taber');
(1018157845, 'Louise Fletcher', 'Nurse Mildred Ratched');
(1018157845, 'Will Sampson', 'Chief\' Bromden');
(78809918, 'Mark Hamill', 'Luke Skywalker');
(78809918, 'Harrison Ford', 'Han Solo');
(78809918, 'Carrie Fisher', 'Princess Leia Organa');
(78809918, 'Billy Dee Williams', 'Lando Calrissian');
(78809918, 'Anthony Daniels', 'C-3PO');
(63545791, 'Jodie Foster', 'Clarice Starling');
(63545791, 'Anthony Hopkins', 'Dr. Hannibal Lecter');
(63545791, 'Scott Glenn', 'Jack Crawford');
(63545791, 'Ted Levine', 'Jame \'Buffalo Bill\' Gumb');
(63545791, 'Anthony Heald', 'Dr. Frederick Chilton');
(503062450, 'Brad Pitt', 'Detective David Mills');
(503062450, 'Morgan Freeman', 'Detective William Somerset');
(503062450, 'Kevin Spacey', 'John Doe');
(503062450, 'Gwyneth Paltrow', 'Tracy Mills');
(503062450, 'Richard Roundtree', 'Martin Talbot');
(1249678210, 'Tom Hanks', 'Captain Miller');
(1249678210, 'Tom Sizemore', 'Sergeant Horvath');
(1249678210, 'Edward Burns', 'Private Reiben');
(1249678210, 'Barry Pepper', 'Private Jackson');
(1249678210, 'Adam Goldberg', 'Private Mellish');
(1346231625, 'Tom Hanks', 'Paul Edgecomb');
(1346231625, 'Michael Clark Duncan', 'John Coffey');
(1346231625, 'David Morse', 'Brutus \'Brutal\' Powell');
(1346231625, 'Bonnie Hunt', 'Jan Edgecomb');
(1346231625, 'James Cromwell', 'Hal Moores');
(1406772068, 'Shameik Moore', 'Miles Morales');
(1406772068, 'Hailee Steinfeld', 'Gwen Stacey');
(1406772068, 'Brian Tyree Henry', 'Jeff Morales');
(1406772068, 'Luna Lauren Velez', 'Rio Morales');
(1406772068, 'Jake Johnson', 'Peter Parker');
(392316929, 'Kevin Spacey', 'Jack Vincennes');
(392316929, 'Russel Crowe', 'Officer Wendell \'Bud\' White');
(392316929, 'Guy Pearce', 'Detective Lieutenant Edmund Jennings Exley');
(392316929, 'Kim Bassinger', 'Lynn Bracken');
(392316929, 'Danny DeVito', 'Sid Hudgens');
(851421447, 'Humphrey Bogart', 'Rick Blaine');
(851421447, 'Ingrid Bergman', 'Ilsa Lund');
(851421447, 'Paul Henreid', 'Victor Laszlo');
(851421447, 'Calude Rains', 'Captain Louis Renault');
(851421447, 'Conrad Veidt', 'Major Heinrich Strasser');
(894020390, 'Toshiro Mifune', 'Kikuchiyo');
(894020390, 'Takashi Shimura', 'Kambei Shimada');
(894020390, 'Yoshio Inaba', 'Gorobei Katayama');
(894020390, 'Seiji Miyaguchi', 'Kyuzo');
(894020390, 'Minoru Chiaki', 'Heinachi Hayashida');
(251907923, 'Song Kang-Ho', 'Ki Taek');
(251907923, 'Leen Sun-Kyun', 'Dong Ik');
(251907923, 'Cho Yeo-Jeong', 'Yeon Kyo');
(251907923, 'Choi Woo-Sik', 'Ki Woo');
(251907923, 'Park So-Dam', 'Ki Jung');
(1520277541, 'Tom Cruise', 'Captain Pete \'Maverick\' Mitchell');
(1520277541, 'Val Kilmer', 'Admiral Tom \'Iceman\' Kazansky');
(1520277541, 'Miles Teller', 'Lieutenant Bradley \'Rooster\' Bradshaw');
(1520277541, 'Jennifer Connelly', 'Penny Benjamin');
(1520277541, 'Bashir Salahuddin', 'CWO4 Bernie \'Hondo\' Coleman');
(621794419, 'Tom Hanks', 'Woody');
(621794419, 'Tim Allen', 'Buzz Lightyear');
(621794419, 'Joan Cusack', 'Jessie');
(621794419, 'Kelsey Grammer', 'Prospector');
(621794419, 'Don Rickles', 'Mr. Potato Head');
(1764633906, 'Jack Nicholson', 'J.J. Gittes');
(1764633906, 'Faye Dunaway', 'Evelyn Mulwray');
(1764633906, 'John Huston', 'Noah Cross');
(1764633906, 'Perry Lopez', 'Escobar');
(1764633906, 'John Hillerman', 'Yelburton');
(1579164841, 'Marlon Brando', 'Terry Malloy');
(1579164841, 'Lee J. Cobb', 'Johnny Friendly');
(1579164841, 'Karl Malden', 'Father Barry');
(1579164841, 'Rod Steiger', 'Charley \'The Gent\' Malloy');
(1579164841, 'Eva Marie Saint', 'Edie Doyle');
(348536626, 'Jean Martin', 'Colonel Philippe Mathieu');
(348536626, 'Saadi Yacef', 'El-Hadi Jafar');
(348536626, 'Brahim Haggiag', 'Ali La Pointe');
(348536626, 'Tommaso Neri', 'Captain Dubois');
(348536626, 'Samia Kerbash', 'Fathia');
(1604333879, 'Tom Hanks', 'Woody');
(1604333879, 'Tim Allen', 'Buzz Lightyear');
(1604333879, 'Don Rickles', 'Mr. Potato Head');
(1604333879, 'Jim Varney', 'Slinky Dog');
(1604333879, 'Wallace Shawn', 'Rex');
(870673075, 'James Stewart', 'L.B. Jeffries');
(870673075, 'Grace Kelly', 'Lisa Fremont');
(870673075, 'Wendell Corey', 'Tom Doyle');
(870673075, 'Thelma Ritter', 'Stella');
(870673075, 'Raymond Burr', 'Lars Thorwald');
(1904087280, 'Charlie Chaplin', 'Factory Worker \'The Tramp\'');
(1904087280, 'Paulette Goddard', 'Ellen Peterson \'The Gamin\'');
(1904087280, 'Henry Bergman', 'Cafe Owner');
(1904087280, 'Stanley Sandford', 'Big Bill');
(1904087280, 'Chester Conklin', 'Mechanic');
(1599220560, 'Jay Baruchel', 'Hiccup');
(1599220560, 'America Ferrera', 'Astrid');
(1599220560, 'Gerard Butler', 'Stoick');
(1599220560, 'Craig Ferguson', 'Gobber');
(1599220560, 'Christopher Mintz-Plasse', 'Fishlegs');
(1154659227, 'Bette Davis', 'Margo Channing');
(1154659227, 'Anne Baxter', 'Eve Harrington');
(1154659227, 'George Sanders', 'Addison DeWitt');
(1154659227, 'Celeste Holm', 'Karen Richards');
(1154659227, 'Gary Merrill', 'Bill Sampson');
(304861570, 'Daveigh Chase', 'Chihiro Ogino');
(304861570, 'Suzanne Pleshette', 'Yububa / Zeniba');
(304861570, 'Jason Marsden', 'Haku');
(304861570, 'Susan Egan', 'Lin');
(304861570, 'David Ogden Stiers', 'Kamaji');
(1756517886, 'Edward Asner', 'Carl Fredericksen');
(1756517886, 'Jordan Nagai', 'Russel');
(1756517886, 'John Ratzenberger', 'Construction Foreman');
(1756517886, 'Christopher Plummer', 'Charles Muntz');
(1756517886, 'Bob Peterson', 'Dug');
(2084554881, 'Orson Welles', 'The Third Man');
(2084554881, 'Joseph Cotten', 'Holly Martins');
(2084554881, 'Trevor Howard', 'Major Calloway');
(2084554881, 'Alida Valli', 'Anna Schmidt');
(2084554881, 'Paul Hoerbiger', 'Porter');
(460482582, 'Mark Ruffalo', 'Mike Rezendes');
(460482582, 'Michael Keaton', 'Walter \'Robby\' Robinson');
(460482582, 'Rachel McAdams', 'Sacha Pfeiffer');
(460482582, 'Liev Schreiber', 'Marty Baron');
(460482582, 'John Slattery', 'Ben Bradlee Jr.');
(559276553, 'Shameik Moore', 'Miles Morales');
(559276553, 'Jake Johnson', 'Peter Parker');
(559276553, 'Hailee Steinfeld', 'Gwen Stacey');
(559276553, 'Mahershala Ali', 'Uncle Aaron');
(559276553, 'John Mulaney', 'Spider-Ham');
(2097654371, 'Katherine Hepburn', 'Tracy Lord');
(2097654371, 'Cary Grant ', 'C.K. Dexter Haven');
(2097654371, 'James Stewart', 'Macaulay \'Mike\' Connor');
(2097654371, 'Ruth Hussey', 'Elizabeth \'Liz\' Imbrie');
(2097654371, 'John Howard', 'George Kittredge');
(79863599, 'Albert Brooks', 'Marlin');
(79863599, 'Ellen DeGeneres', 'Dory');
(79863599, 'Alexander Gould', 'Nemo');
(79863599, 'Willem Dafoe', 'Gill');
(79863599, 'Brad Garrett', 'Bloat');
(893597994, 'Gene Kelly', 'Don Lockwood');
(893597994, 'Debbie Reynolds', 'Kathy Selden');
(893597994, 'Donald O\'Conner', 'Cosmo Brown');
(893597994, 'Jean Hagen', 'Lina Lamont');
(893597994, 'Millard Mitchell', 'R.F. Simpson');
(1458767573, 'Artur Barcis', 'Many characters');
(1458767573, 'Olgierd Lukaszewics', 'Andrzej Geller');
(1458767573, 'Olaf Lubaszenko', 'Tomek');
(1458767573, 'Aleksander Bardini', 'Consultant');
(1458767573, 'Krystyna Janda', 'Dorota Geller');
(1919595503, 'Burt Lancaster', 'Prince Don Fabrizio Salina');
(1919595503, 'Claudi Cardinale', 'Angelica Sedara');
(1919595503, 'Alain Delon', 'Tancredi Falconeri');
(1919595503, 'Paolo Stoppa', 'Don Calogera Sedara');
(1919595503, 'Rina Morelli', 'Princess Maria Stella Salina');
(1822561486, 'Peter O\'Toole', 'Lawrence');
(1822561486, 'Alec Guinness', 'Prince Faisal');
(1822561486, 'Anthony Quinn', 'Auda Abu Tayi');
(1822561486, 'Jack Hawkins', 'General Edmund Allenby');
(1822561486, 'Omar Sharif', 'Sherif Ali');
(1265595906, 'Chishu Ryu', 'Shukichi Hirayama');
(1265595906, 'Chieko Higashiyama', 'Tomi Hirayama');
(1265595906, 'Setsuko Hara', 'Noriko Hirayama');
(1265595906, 'Haruko Sugimura', 'Shige Kaneko');
(1265595906, 'So Yamamura', 'Koichi Hiryama');
(263148316, 'Irene Jacob', 'Valentine');
(263148316, 'Jean-Louis Trintignant', 'Le Juge');
(263148316, 'Frederique Feder', 'Karin');
(263148316, 'Jean-Pierre Lorit', 'Auguste');
(263148316, 'Samuel Le Bihan', 'Photographer');
(1384189524, 'Jean-Louis Trintignant', 'Marcello Clerici');
(1384189524, 'Stefania Sandrelli', 'Giulia');
(1384189524, 'Gastone Moschin', 'Manganiello');
(1384189524, 'Enzo Tarascio', 'Professor Quadri');
(1384189524, 'Fosco Giachetti', 'Il Colonnello');
(888705962, 'Joseph Cotten', 'Jedediah Leland');
(888705962, 'Dorothy Comingore', 'Susan Alexander Kane');
(888705962, 'Agnes Moorehead', 'Mary Kane');
(888705962, 'Ruth Warrick', 'Emily Monroe Norton Kane');
(888705962, 'Ray Collins', 'James W. Gettys');
(1232541097, 'Ellar Coltrane', 'Mason');
(1232541097, 'Patricia Arquette', 'Olivia');
(1232541097, 'Elijah Smith', 'Tommy');
(1232541097, 'Lorelei Linklater', 'Samantha');
(1232541097, 'Steven Chester Prince', 'Ted');
(424396053, 'James Stewart', 'John \'Scottie\' Ferguson');
(424396053, 'Kim Novak', 'Madeleine Elster / Judy Barton');
(424396053, 'Barbara Bel Geddes', 'Marjorie \'Midge\' Wood');
(424396053, 'Tom Helmore', 'Gavin Elster');
(424396053, 'Henry Jones', 'Coroner');
(987302716, 'Cary Grant', 'Devlin');
(987302716, 'Ingrid Bergman', 'Alicia Huberman');
(987302716, 'Claude Rains', 'Alexander Sebastian');
(987302716, 'Louise Calhern', 'Paul Prescott');
(987302716, 'Leopoldine Konstantin', 'Madame Sebastian');
(755957868, 'Kristina Adolphson', 'Siri ');
(755957868, 'Borje Ahlstedt', 'Carl Ekdahl');
(755957868, 'Pernilla Allwin', 'Fanny Ekdahl');
(755957868, 'Kristian Almgren', 'Putte Ekdahl');
(755957868, 'Carl Billquist', 'Polisintendent Jespersson');
(1615377061, 'Jacques Tati', 'Monsieur Hulot');
(1615377061, 'Barbara Dennek', 'Barbara');
(1615377061, 'Rita Maiden', 'La compagne de M. Schultz');
(1615377061, 'France Rumilly', 'La Vendeuse De Lunettes');
(1615377061, 'France Delahalle', 'Un Cliente Dans Le Grand Magasin');
(326674215, 'Charlton Heston', 'Mike Vargas');
(326674215, 'Janet Leigh', 'Susan Vargas');
(326674215, 'Orson Welles', 'Captain Hank Quinlan');
(326674215, 'Joseph Calleia', 'Sergeant Pete Menzies');
(326674215, 'Akim Tamiroff', 'Uncle\' Joe Grandi');
(407910799, 'Lino Ventura', 'Philippe Gerbier');
(407910799, 'Paul Meurisse', 'Luc Jardie');
(407910799, 'Jean-Pierre Cassel', 'Jean Francois Jardie');
(407910799, 'Simone Signoret', 'Mathilde');
(407910799, 'Claude Mann', 'Claude Ullmann Dit \'Le Masque\'');
(424735752, 'Charlie Chaplin', 'A Tramp');
(424735752, 'Virginia Cherrill', 'Blind Girl');
(424735752, 'Florrence Lee', 'Blind Girl\'s Grandmother');
(424735752, 'Harry Myers', 'Eccentric Millionaire');
(424735752, 'Al Ernest Garcia', 'Millionaire\'s Butler');
(1024068360, 'Mahershala Ali', 'Juan');
(1024068360, 'Shariff Earp', 'Terrence');
(1024068360, 'Duan Sanderson', 'Azu');
(1024068360, 'Alex R. Hibbert', 'Little');
(1024068360, 'Janelle Monae', 'Teresa');
(336048821, 'Lillian Gish', 'Eternal Mother');
(336048821, 'Mae Marsh', 'The Dear One');
(336048821, 'Robert Harron', 'The Boy');
(336048821, 'F.A. Turner', 'The Dear One\'s Father');
(336048821, 'Sam De Grasse', 'Arthur Jenkins');
(401123580, 'Nora Gregor', 'Christine De La Cheyniest');
(401123580, 'Paulette Dubost', 'Lisette');
(401123580, 'Mila Parely', 'Genevieve De Marras');
(401123580, 'Odette Talazac', 'Madame De La Plante');
(401123580, 'Claire Gerard', 'Madame De La Bruyere');
(1348419192, 'Dickie Jones', 'Pinocchio');
(1348419192, 'Mel Blanc', 'Gideon');
(1348419192, 'Cliff Edwards', 'Jimini Cricket');
(1348419192, 'Walter Catlett', 'J. Worthington Foulfellow');
(1348419192, 'Frankie Darro', 'Lampwick');
(598288868, 'William Holden', 'Pike');
(598288868, 'Ernest Borgnine', 'Dutch');
(598288868, 'Robert Ryan', 'Thornton');
(598288868, 'Edmond O\'Brien', 'Sykes');
(598288868, 'Warren Oates', 'Lyle Gorch');